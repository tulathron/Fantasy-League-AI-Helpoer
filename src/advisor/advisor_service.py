        ...
        async with self._http_factory.client() as http_client:
            ...
            for roster in rosters:
                ...
                if roster_id is None:
                    continue
                owner_map[roster_id] = self._lookup_owner_name(roster.get("owner_id"), users)

            target_roster = roster_map.get(roster_id) if roster_id else rosters[0]
            owner = owner_map.get(target_roster["roster_id"], "Unknown Manager")
